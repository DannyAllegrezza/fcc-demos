let pomodoroTimer = (function () {
	...
	let _historyList = document.querySelector(".app-pomodoros-list");
	...
	let updateHistory = function (currentType) {
		...
		if (currentType === "SESSION") {
			li.appendChild(document.createTextNode(`Session completed! (${_state.pomodorosCompleted} total)`));
		} else {
			li.appendChild(document.createTextNode(`Break completed! (${_state.breaksCompleted} total)`));
		}
